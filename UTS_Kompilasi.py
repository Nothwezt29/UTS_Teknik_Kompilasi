...
Karena operator pangkat (^) memiliki prioritas lebih tinggi
dibanding operator perkalian (*) dan pembagian (/).
...
Dengan hierarki ini, operasi pangkat akan diproses terlebih
dahulu sebelum perkalian atau pembagian sesuai aturan
Operator Precedence pada matematika.


2. Apa yang terjadi pada fase Analisis Semantik jika variabel
   z digunakan tetapi tidak ada di symbol_table?

Fase Analisis Semantik akan mendeteksi error karena variabel
...
Hal ini disebut undeclared variable error.


3. Mengapa instruksi untuk a ^ 2 harus muncul sebelum
   instruksi untuk + dalam TAC?

Karena TAC mengikuti urutan evaluasi berdasarkan prioritas
operator dan dependency data.

Operasi pangkat harus dihitung terlebih dahulu agar hasilnya
dapat digunakan pada operasi berikutnya.
...
Nilai t1 dan t2 harus tersedia terlebih dahulu sebelum
